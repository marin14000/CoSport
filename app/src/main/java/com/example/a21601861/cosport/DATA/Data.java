...
public class Data {
    ...
    public static List<ActivityDesc> activity;
    ...
    public Data(){
        ...
        List<ActivityDesc> act=r.getListOfAct();
        Data.activity=ActivityDescImp.sort(act);
  ...
  /* *//* private static Calendar date1 =Calendar.getInstance();
    ...
    private static DataStorageAccess dsa=DataStorageAccess.getInstance();
    private static List<User> userList=dsa.
            *//*new ArrayList<>(Arrays.asList((User)
            ...
            new UserImp(R.mipmap.tete,"marinette","marine","bleu",25,"marine@gmail.com","7532","f","blablabla"),
            new UserImp(R.mipmap.tete,"caro","caroline","delahaye",35,"delahaye@unicaen.fr","4521","f","blablavbla"),
            new UserImp(R.mipmap.tete,"nono","bruno","lorange",45,"lorange@hotmail.fr","78521","h","blablabla"),
            new UserImp(R.mipmap.tete,"loulou","louise","attaque",19,"attaque@gmail.com","8426","f","blablabla"),
            new UserImp(R.mipmap.tete,"chacha","charlotte","la Fourmi",24,"charlotelafourmi@gmail.com","1535","f","blablabla"),

            new UserImp(R.mipmap.tete,"ben","benjamin","de l'amour",23,"delamour@gmail.com","mimomu","h","blablabla"),
            new UserImp(R.mipmap.tete,"cathy","catherine","delarue",30,"delarue@hotmail.fr","qgqkejfrgjqkeng","f","blablabla"),
            new UserImp(R.mipmap.tete,"marin","marin","lechamps",29,"lechamps@gmail.com","zzf64Z","h","blablabla"),
            new UserImp(R.mipmap.tete,"jul","julien","pataproute",35,"pataproue@gmail.com","rglsk","h","blablabla"),
            new UserImp(R.mipmap.tete,"adrien","adrien","delaplante",19,"delaplante@gmail.com","78+45","h","blablabla")
    ));*//*
            static{
                dsa.getListActivity();
                Result r=dsa.getResult();
                public static ArrayList<ActivityDesc> activityUnsorted=r.getListOfAct();
            }

            *//*new ArrayList<>(Arrays.asList((ActivityDesc)
            ...
            new ActivityDescImp(R.mipmap.natation,"Natation","Caen stade nautique",date7,userList.get(6).getId()),
    ...
    public static User currentUser=new UserImp("http://192.168.1.15/images/homme.png","admin","marin","Dorange",20,"marin.do@hotmail.fr","0123456789","h","" +
            "Passionné d'escalade je pratique ce sport depuis 4 à 5 ans. Depuis peu, je me suis mis à découvrir et à aimer l'escalade en extérieur malheureusement " +
